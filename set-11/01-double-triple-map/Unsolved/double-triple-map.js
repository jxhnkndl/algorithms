...
/**
 * 1) Map over number array
 * 2) Check whether current number is odd or even
 * 3) If number is even, return the number x2
 * 4) If number is odd, return the number x3
 * 5) Return the new array
 */

var doubleTripleMap = function (arr) {
  var updatedArr = arr.map((num) => {
    if (num % 2 === 0) {
      return num * 2;
    } else {
      return num * 3;
